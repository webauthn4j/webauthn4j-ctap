...
UnifidoKey offers two types of transport methods.
NFC transport and Bluetooth HID transport.
...
The reader must support NFC.
The reader which only supports Felica and MIFARE doesn't work.

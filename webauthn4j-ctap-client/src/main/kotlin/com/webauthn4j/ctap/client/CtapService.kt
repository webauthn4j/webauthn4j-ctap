...
/**
 * Ctap Client, which provides high-level API on the top of [CtapClient]
 */
open class CtapService(protected val ctapClient: CtapClient) {
    ...
    suspend fun makeCredential(
        ...
        val getInfoResponse: AuthenticatorGetInfoResponse = ctapClient.getInfo()
        ...
        val authenticatorMakeCredentialResponse = when (userVerificationStrategy) {
            UserVerificationStrategy.AUTHENTICATOR_UV -> {
                ...
                val makeCredentialResponse = ctapClient.makeCredential(
    ...
    suspend fun getAssertions(getAssertionsRequest: GetAssertionsRequest, getAssertionContext: GetAssertionContext): GetAssertionsResponse {
        ...
        return GetAssertionsResponse(getInfoResponseData, list)
    }
    ...
    suspend fun setPIN(newPIN: String) {
        ...
        val clientPINResponse: AuthenticatorClientPINResponse =
            ctapClient.clientPIN(getKeyAgreementSubCommand)
        ...
        ctapClient.clientPIN(setPINSubCommand)
    }
    ...
    suspend fun getRetries(): UInt {
        ...
        val clientPINResponse = ctapClient.clientPIN(getRetriesSubCommand)
        val clientPINResponseData = clientPINResponse.responseData ?: throw ResponseDataValidationException(RESPONSE_DATA_NULL_MESSAGE)
    ...
    private suspend fun requestPINToken(clientPIN: ByteArray): ByteArray {
        ...
        val getKeyAgreementResponse: AuthenticatorClientPINResponse =
            ctapClient.clientPIN(AuthenticatorClientPINRequest.createV1GetKeyAgreement())
        ...
        val getPINTokenResponse: AuthenticatorClientPINResponse = ctapClient.clientPIN(
    ...
    private enum class UserVerificationStrategy {
        AUTHENTICATOR_UV, CLIENT_PIN_UV, NO_UV
    }

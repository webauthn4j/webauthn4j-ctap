...
import com.webauthn4j.ctap.core.data.options.PlatformOption.Companion.PLATFORM
...
class WebAuthnClient(
    ...
    private val logger: Logger = LoggerFactory.getLogger(WebAuthnClient::class.java);
    ...
    suspend fun create(
        ...
        val attestationObject = when (publicKeyCredentialCreationOptions.attestation) {
            ...
            AttestationConveyancePreference.INDIRECT ->{
                logger.warn("Indirect attestation is not yet supported.")
                makeCredentialResponse.attestationObject //TODO: implement replacing the attestation with anonymous but verifiable one
            }
            AttestationConveyancePreference.DIRECT -> makeCredentialResponse.attestationObject
            AttestationConveyancePreference.ENTERPRISE -> {
                logger.warn("Enterprise attestation is not yet supported.")
                makeCredentialResponse.attestationObject //TODO: implement enterprise attestation
            }
        ...
        val transports: Set<AuthenticatorTransport> = makeCredentialResponse.getInfoResponseData.transports?.toSet() ?: emptySet()
    ...
    suspend fun get(
        ...
        return PublicKeyCredential(
            ...
            convertToAttachment(getAssertionsResponse.getInfoResponseData.options?.plat),
    ...
    private fun convertToAttachment(platformOption: PlatformOption?): AuthenticatorAttachment{
        return when(platformOption){

...
internal class UPNotSupportedExceptionTest {

    private val cause = RuntimeException()

    @Test
    fun test() {
        val exception1 = UPNotSupportedException("dummy", cause)
        val exception2 = UPNotSupportedException("dummy")
        val exception3 = UPNotSupportedException(cause)
        assertAll(

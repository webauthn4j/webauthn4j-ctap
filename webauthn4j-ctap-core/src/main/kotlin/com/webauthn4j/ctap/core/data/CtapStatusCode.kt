...
class CtapStatusCode(private val value: Byte) {
    companion object {
        ...
        val CTAP2_ERR_FP_DATABASE_FULL = CtapStatusCode(0x17)
        val CTAP2_ERR_LARGE_BLOB_STORAGE_FULL = CtapStatusCode(0x18)
        ...
        val CTAP2_ERR_PUAT_REQUIRED = CtapStatusCode(0x36)
        ...
        val CTAP2_ERR_INTEGRITY_FAILURE = CtapStatusCode(0x3D)
        val CTAP2_ERR_INVALID_SUBCOMMAND = CtapStatusCode(0x3E)
        ...
        init {
            ...
            tmp[CTAP2_ERR_FP_DATABASE_FULL] = "CTAP2_ERR_FP_DATABASE_FULL"
            tmp[CTAP2_ERR_LARGE_BLOB_STORAGE_FULL] = "CTAP2_ERR_LARGE_BLOB_STORAGE_FULL"
            ...
            tmp[CTAP2_ERR_INTEGRITY_FAILURE] = "CTAP2_ERR_INTEGRITY_FAILURE"
            tmp[CTAP2_ERR_INVALID_SUBCOMMAND] = "CTAP2_ERR_INVALID_SUBCOMMAND"

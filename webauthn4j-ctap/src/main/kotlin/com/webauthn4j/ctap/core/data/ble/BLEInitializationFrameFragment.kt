...
class BLEInitializationFrameFragment(val cmd: BLEFrameCommand, val length: Int, data: ByteArray) :
    BLEFrameFragment {
    ...
    override val bytes: ByteArray
        get() {
            ...
            byteBuffer.put(UnsignedNumberUtil.toBytes(length))
            byteBuffer.put(data)
    ...
    companion object {
        ...
        fun parse(bytes: ByteArray): BLEInitializationFrameFragment {
            ...
            val length = UnsignedNumberUtil.getUnsignedShort(byteBuffer)
